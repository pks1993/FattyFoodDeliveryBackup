                                ...
                                <table id="riders" class="table table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="text-center">
                                            ...
                                            <td class="text-center">{{ $rider->rider_order_daily->where('order_type','food')->count() }}</td>
                                            <td class="text-center">{{ $rider->rider_order_daily->where('order_type','parcel')->count() }}</td>
                                            <td class="text-center">{{ $rider->rider_order_daily->sum('bill_total_price') }}</td>
                                        </tr>
                                        @endforeach
                                    </tbody>
                                </table>
