        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-5">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">Food Ordes</li>
...
<nav>
    <div class="nav nav-tabs nav-fill" id="nav-tab" role="tablist">
        <a class="nav-item nav-link active" id="nav-home-tab" data-toggle="tab" href="#nav-home" role="tab" aria-controls="nav-home" aria-selected="true">Daily Food Orders Report</a>
        <a class="nav-item nav-link" id="nav-profile-tab" data-toggle="tab" href="#nav-profile" role="tab" aria-controls="nav-profile" aria-selected="false">Monthly Food Orders Report</a>
        <a class="nav-item nav-link" id="nav-contact-tab" data-toggle="tab" href="#nav-contact" role="tab" aria-controls="nav-contact" aria-selected="false">Yearly Food Orders Report</a>
    </div>
</nav>
...
<script>
    $(document).ready(function () {
        ...
        Highcharts.chart('monthly', {
            ...
            title: {
                text: 'Monthly Food Orders Report'
            },
        ...
        Highcharts.chart('yearly', {
            ...
            title: {
                text: 'Yearly Food Orders Report'
            },
