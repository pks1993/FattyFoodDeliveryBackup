...
<ul class="nav nav-pills navbar-inverse">
    ...
    <li class="nav-item">
        <a href="{{ url('admin_parcel_orders/report/'.$customer_admin_id) }}" class="nav-link" style="width: 100%;color: #FFF;font-size:13px;font-weight:545;">MyReport</a>
    </li>
    <li class="nav-item">
        <a href="{{ url("admin_rider_order/all_report/".$customer_admin_id) }}" style="background-color:#28a745;width: 100%;color: #FFF;font-size:13px;font-weight:545;" id="home-tab" data-toggle="pill" href="#home" role="tab" aria-controls="home" aria-selected="true">AllReport</a>
    </li>
    <li class="nav-item">
