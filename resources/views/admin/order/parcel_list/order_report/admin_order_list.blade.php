...
<ul class="nav nav-pills navbar-inverse">
    ...
    <li class="nav-item">
        <a href="{{ url("admin_rider_order/list/".$customer_admin_id) }}" style="background-color:#28a745;width: 100%;color: #FFF;font-size:15px;font-weight:510;" id="home-tab" data-toggle="pill" href="#home" role="tab" aria-controls="home" aria-selected="true">RiderReport</a>
    </li>
    <li class="nav-item">
                ...
                <div class="" style="padding:5px;">
                    ...
                    <div class="ml-1 mt-2 mr-1" style="margin-bottom: 75px;">
                        ...
                        @foreach ($orders as $order)
                            ...
                            <a class="btn btn-block btn-success text-white border mt-1" id="hide{{ $order->order_id }}" style="display: none;">
                                <div class="container-fluid">
                            ...
                            <div id="order{{ $order->order_id }}" class="container-fluid mt-2" style="border: 1px solid red; border-radius: 5px; display: none;">
                                <div class="row p-1">
