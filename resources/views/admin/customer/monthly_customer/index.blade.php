                    ...
                    <div class="table-responsive">
                        <div class="row">
                            <div class="col-md-6 mt-1">
                                <form action="{{ url('fatty/main/admin/monthly_customers') }}">
                                    <input class="col-4 col-md-4" type="month" name="start_date" value="{{ \Carbon\Carbon::parse($date_start)->startOfMonth()->format('Y-m') }}" class="btn mb-1" style="background-color:#FFFFFF;width: 100%;height:33px;border-color:#00dfc2;border-style:solid;border-width:2px;color: #1c1a1a;font-size:15px;font-weight:510;border-radius:5px">
                            ...
                            <div class="col-md-6 mt-1">
                                <form action="{{ url('fatty/main/admin/monthly_customers/search') }}">
                                    ...
                                    <input hidden class="col-5 col-md-2" type="month" name="start_date" value="{{ \Carbon\Carbon::parse($date_start)->startOfMonth()->format('Y-m') }}" class="btn mb-1" style="background-color:#FFFFFF;width: 100%;border-color:#00dfc2;border-style:solid;border-width:2px;color: #1c1a1a;font-size:15px;font-weight:510;border-radius:5px">
