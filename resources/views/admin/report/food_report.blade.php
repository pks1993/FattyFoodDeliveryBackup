                ...
                <div class="card">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <form method='post' action="{{ route('fatty.admin.backup.all_food_orders') }}">
                                    ...
                                    <input type="submit" class="btn btn-sm mb-1" style="background-color: #000335;color: #FFFFFF;" name="all_food_order_exportexcel" value='Excel Export'>
                                </form>
                            </div>
                    ...
                    <div class="card-body table-responsive">
                        <div class="col-12 mb-3">
                            <form action="{{ url('fatty/main/admin/riders/food_order/report') }}">
                        ...
                        <table id="foods_orders" class="table table-bordered table-striped table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ ($value->bill_total_price*$value->restaurant->percentage/100)." (".$value->restaurant->percentage."%)" }}</td>
                                    <td>{{ $value->rider_delivery_fee }}</td>
                                    <td>{{($value->bill_total_price*$value->restaurant->percentage/100)-$value->rider_delivery_fee }}</td>
                                </tr>
                                @endforeach
                            </tbody>
                        </table>
