                        ...
                        <div class="card-header">
                            <div class="row">
                                ...
                                <div class="col-md-6" style="text-align: right">
                                    <a href="{{url('fatty/main/admin/restaurants/user/create')}}" class="btn btn-primary btn-sm"><i class="fa fa-angle-double-left"></i> Back to <span>lists</span></a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card-body">
                            <form method="POST" action="{{ route('fatty.admin.restaurants.store') }}" autocomplete="off" enctype="multipart/form-data">
                                ...
                                <div class="form-group row">
                                    <label for="restaurant_phone" class="col-md-12 col-form-label">{{ __('Restaurant User Phone') }} <span  style="color: #990000;font-weight:700;">*</span></label>
                                    <div class="col-md-12">
                                        <input type="hidden" name="restaurant_user_id" value="{{ $restaurant_user->restaurant_user_id }}">
                                        <input type="text" id="restaurant_phone" class="form-control @error('restaurant_phone') is-invalid @enderror" value="{{ $restaurant_user->restaurant_user_phone }}" name="restaurant_phone" autocomplete="restaurant_phone">{{ old('restaurant_phone') }}
                                ...
                                <div class="form-group row mb-0">
                                    <div class="col-md-12">
                                        ...
                                        <a href="{{url('fatty/main/admin/restaurants/user/create')}}" class="btn btn-secondary btn-sm" onclick="return confirm('Are you sure cancel?')">
