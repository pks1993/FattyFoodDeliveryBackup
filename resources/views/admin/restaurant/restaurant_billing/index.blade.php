                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="{{ url('fatty/main/admin/restaurants_billing/store','[{"restaurant_id":'.$value->restaurant_id.',"total_amount":'.$value->total_amount.',"percentage":'.$value->percentage.',"pay_amount":'.$value->pay_amount.',"duration":'.$value->duration.'}]') }}" class="btn btn-sm btn-danger" style="width: 80px;">Confirm</a>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
