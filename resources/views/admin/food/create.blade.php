                        ...
                        <div class="card-body">
                            <form method="POST" action="{{ route('fatty.admin.foods.store') }}" autocomplete="off" enctype="multipart/form-data">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-12">
                                        <input id="food_price" type="number" class="form-control @error('food_price') is-invalid @enderror" name="food_price" value="{{ old('food_price') }}" autocomplete="food_price" autofocus>
                                        @error('food_price')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
