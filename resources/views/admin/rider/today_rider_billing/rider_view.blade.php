    ...
    <div class="row" style="padding-top: 10px;">
        <div class="col">
            <ul class="nav nav-pills">
                ...
                <li class="nav-item col btn">
                    <a href="{{ url('fatty/main/admin/today_rider_billing/data_history/'.$rider_id) }}" class="nav-link" style="background-color:#FFFFFF;width: 100%;border-color:#00dfc2;border-style:solid;border-width:2px;color: #1c1a1a;font-size:15px;font-weight:510;border-radius:5px;">History</a>
                </li>
            </ul>
        </div>
    </div>
                        ...
                        <div class="card-body mt-4" style="width: 100%;color: #000000;font-size:15px;border-radius:5px;padding:10px;border-style:solid;border-width:2px;border-color:#00dfc2;background-color:#FFFFFF">
                            ...
                            <div class="row">
                                <div class="col text-center" style="margin-top:50px;margin-bottom:10px;">
                                    <a href="{{ url('fatty/main/admin/today_rider_billing/update',$rider_payment->rider_today_payment_id) }}"  class="btn btn-sm" style="width: 80%;background-color:#00dfc2;color:#FFFFFF;font-weight:510;">Accept</a>
                                </div>
                            </div>
                        </div>
                    @endif
