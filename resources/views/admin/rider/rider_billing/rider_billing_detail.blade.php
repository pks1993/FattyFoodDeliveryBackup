                                        ...
                                        <tr>
                                            <th colspan="4">
                                                <div class="row">
                                                    ...
                                                    <div class="col-6 text-right" style="font-size: 16px">{{ number_format($value->total_food_income + $value->total_parcel_income) }} MMK</div>
                                                </div>
                                            </th>
                                        </tr>
                                    </thead>
