                ...
                <div class="col-md-6">
                    <div class="card">
                        <div class="card-header">
                            <div class="row">
                                <div class="col-md-6">
                                    <h3 class="card-title" style="font-weight: 550;">Edit "{{ $rider->rider_user_name }}"</h3>
                                </div>
                        ...
                        <div class="card-body">
                            <form method="POST" action="{{ route('fatty.admin.riders.update',$rider->rider_id) }}" autocomplete="off" enctype="multipart/form-data">
                                @csrf
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-12">
                                        <input id="rider_user_name" type="text" class="form-control @error('rider_user_name') is-invalid @enderror" name="rider_user_name" value="{{ $rider->rider_user_name }}" autocomplete="rider_user_name" autofocus>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-12">
                                        <input id="rider_user_phone" type="text" class="form-control @error('rider_user_phone') is-invalid @enderror" name="rider_user_phone" value="{{ $rider->rider_user_phone }}" autocomplete="rider_user_phone" autofocus>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-12">
                                        <input id="password_confirmation" type="password" class="form-control" name="password_confirmation" placeholder="minimum 6 characters" value="{{ $rider->rider_user_password }}"  autocomplete="new-password"><span toggle="#password_confirmation" class="fa fa-fw fa-eye field-icon toggle-password"></span> <span id='message'></span>
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6 mt-2">
                                        <div class="form-group">
                                            ...
                                            @if($rider->rider_image==null)
                                                <image src="{{asset('../../../image/available.png')}}" id="imageOne" style="width: 100%;height: 150px;"></image>
                                            @else
                                                <image src="{{asset('../../../uploads/rider/'.$rider->rider_image )}}" id="imageOne" style="width: 100%;height: 150px;"></image>
                                            @endif
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row mb-0">
                                    <div class="col-md-12">
                                        ...
                                        <a href="{{url('fatty/main/admin/riders')}}" class="btn btn-secondary btn-sm">
