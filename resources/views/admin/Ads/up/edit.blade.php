                            ...
                            <form method="POST" action="{{ route('fatty.admin.up_ads.update',$up_ads->up_ads_id) }}" autocomplete="off" enctype="multipart/form-data">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6 mt-2">
                                        <div class="form-group">
                                            @if($up_ads->image_mm)
                                                <image src="../../../../../../uploads/up_ads/{{$up_ads->image_mm}}" id="imageOne" style="width: 100%;height: 150px;"></image>
                                            @else
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6 mt-2">
                                        <div class="form-group">
                                            @if($up_ads->image_en)
                                                <image src="../../../../../../uploads/up_ads/{{$up_ads->image_en}}" id="imageTwo" style="width: 100%;height: 150px;"></image>
                                            @else
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6 mt-2">
                                        <div class="form-group">
                                            @if($up_ads->image_ch)
                                                <image src="../../../../../../uploads/up_ads/{{$up_ads->image_ch}}" id="imageThree" style="width: 100%;height: 150px;"></image>
                                            @else
