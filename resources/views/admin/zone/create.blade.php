            ...
            <div class="row justify-content-center">
                <div class="col-md-7">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form method="POST" action="{{ route('fatty.admin.zones.store') }}" autocomplete="off" enctype="multipart/form-data">
                                @csrf
                                <div class="form-group row">
                                    <label for="zone_name" class="col-md-12 col-form-label">{{ __('Zone Name') }} <span  style="color: #990000;font-weight:700;">*</span></label>
                                    <div class="col-md-12">
                                        <input id="zone_name" type="text" class="form-control @error('zone_name') is-invalid @enderror" name="zone_name" value="{{ old('zone_name') }}" autocomplete="zone_name" autofocus>
                                        @error('zone_name')
