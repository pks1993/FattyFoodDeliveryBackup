...
try {
        ...
        if($response->result=="SUCCESS" && $response->code=="0"){
            ...
            $payment_total=$payment_total_amount-(int)$refund_amount;
	        ...
	        $orde_update = "UPDATE customer_orders SET is_partial_refund=1,restaurant_remark = '$payment_total' WHERE order_id=$orderId;";
