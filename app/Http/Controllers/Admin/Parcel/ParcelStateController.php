...
class ParcelStateController extends Controller
{
    ...
    public function admin_parcel_list(Request $request,$id)
    {
        ...
        $parcel_orders=CustomerOrder::where('order_type','parcel')->where('customer_id',$id)->get();
    ...
    public function admin_parcel_create(Request $request,$id)
    {
        ...
        return view('admin.order.parcel_list.admin_create',compact('parcel_type','extra','from_cities','to_cities','riders','customers','customer_order_count','customer_admin_id'));
    }
