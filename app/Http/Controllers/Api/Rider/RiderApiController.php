...
class RiderApicontroller extends Controller
{
    ...
    public function rider_getBilling_list(Request $request)
    {
        ...
        $peak=$peak_food_amount;
        $benefit=$food_orders_delivery_fee+($total_food_order*$benefit_amount);
