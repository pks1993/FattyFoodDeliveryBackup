...
Route::middleware('one_device_login')->group(function(){
    ...
    Route::post('fatty/202221/lashio/main/admin/parcels/choose_address','Api\StateCity\StateCityApiController@parcel_choose_address');
...
Route::post('fatty/202221/lashio/main/admin/rider/parcels/choose_address','Api\StateCity\StateCityApiController@parcel_choose_address');
...
//parcel
Route::post('fatty/202221/lashio/main/admin/rider/orders/click','Api\Order\OrderApiController@customer_order_click');
Route::post('fatty/202221/lashio/main/admin/rider/parcels/images/delete','Api\Order\ParcelOrderApiController@parcel_image_delete');
Route::get('fatty/202221/lashio/main/admin/rider/parcels/extra/list','Api\Order\ParcelOrderApiController@parcel_extra_list');
Route::get('fatty/202221/lashio/main/admin/rider/parcels/type/list','Api\Order\ParcelOrderApiController@parcel_type_list');
Route::post('fatty/202221/lashio/main/admin/rider/parcels/orders/update','Api\Order\ParcelOrderApiController@rider_order_update');
