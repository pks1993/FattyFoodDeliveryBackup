...
Route::middleware('one_device_login')->group(function(){
    ...
    Route::post('v2/fatty/202221/lashio/main/admin/customers/orders/lists','Api\Order\OrderApiController@v2_customer_index');
    Route::post('v2/fatty/202221/lashio/main/admin/customers/orders/all_lists','Api\Order\OrderApiController@v2_all_customer_index');
    ...
    Route::post('v2/fatty/202221/lashio/main/admin/customer/orders/click','Api\Order\OrderApiController@v2_customer_order_click');
    Route::post('v1/fatty/202221/lashio/main/admin/customers/orders/cancel','Api\Order\OrderApiController@cancel_order_v1');
...
Route::post('v1/fatty/202221/lashio/main/admin/rider/foods/orders/history_list/filter','Api\Rider\RiderApiController@order_food_history_list_filter');
...
Route::post('v1/fatty/202221/lashio/main/admin/restaurants/insight_list','Api\Restaurant\RestaurantApiController@restaurant_insight_list_v1');
...
Route::post('v2/fatty/202221/lashio/main/admin/rider/orders/click','Api\Order\OrderApiController@v2_rider_order_click');
...
Route::post('v2/fatty/202221/lashio/main/admin/rider/parcels/extra/list','Api\Order\ParcelOrderApiController@v2_parcel_extra_list');
